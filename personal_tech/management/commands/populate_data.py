...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        admin_user = User.objects.create_user('admin', 'admin@personaltech.com', 'admin123')
        admin_profile = Profile.objects.create(user=admin_user, role='admin', phone='3001234567', company='Personal Technology')

        tech_user = User.objects.create_user('tech1', 'tech1@personaltech.com', 'tech123')
        tech_profile = Profile.objects.create(user=tech_user, role='technician', phone='3002345678', company='Personal Technology')

        client_user = User.objects.create_user('client1', 'client1@example.com', 'client123')
        client_profile = Profile.objects.create(user=client_user, role='client', phone='3003456789', company='Empresa ABC')
